...
// KMK_CLAUDE_POST_SCREENSHOT_UI_PLAN_2026-08-07 Patch 5 -->
/**
 * Tests for [MangaScreenModel.markSeen]/[MangaScreenModel.clearSeen]'s Evaluation Mode journal
 * wiring -- the fix for the confirmed Batch A Finding 1 defect: the detail-page Not Interested
 * toggle previously wrote [SeenRecommendationMangaStore] directly with zero
