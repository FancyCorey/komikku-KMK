 ...
 * the in-code comment on `KmkRecsReleaseNotes.MARKDOWN` for why that was the safer choice given
 * `WhatsNewScreen`'s existing `MarkdownRender`/`GFMFlavourDescriptor`
