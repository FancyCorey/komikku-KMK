...
/**
 * KMK Code-Only Completion Plan 2026-07-31, Phase 2: [RecommendationsSettingsScreenModel] backs the
 * Sources To Try surface (install, dismiss, quality mark/clear, bulk install) but had zero direct test
 * coverage before this pass. These tests use fake/mocked collaborators only -- no Android package
 * manager, no real extension repository, no network, no Shizuku, no user data -- and prove result
 * classification and journal/event behavior, matching the plan's "safe fixture" requirement.
 *
