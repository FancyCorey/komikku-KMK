    ...
    override fun Content() {
        ...
        val chooseBackupDir = rememberLauncherForActivityResult(
            ...
            if (it != null) {
                ...
                // KMK_CLAUDE_FINAL_SAF_ACTION_HISTORY_RECONCILIATION_PLAN_2026-08-04 Phase 3: the
...
private class CreateBackupScreenModel : StateScreenModel<CreateBackupScreenModel.State>(State()) {
    ...
    // KMK_CLAUDE_FINAL_SAF_ACTION_HISTORY_RECONCILIATION_PLAN_2026-08-04 Phase 3: this write is
...
// KMK_CLAUDE_SAF_EXPORT_TRUTHFULNESS_2026-08-06: extracted so the WorkInfo.State ->
