 ...
 * scripted pass through a handful of screens without unbounded growth); documented in
 * `docs/community/KMK_EVALUATION_MODE_UNDO_JOURNAL.md`. Only the oldest entries are ever evicted --
