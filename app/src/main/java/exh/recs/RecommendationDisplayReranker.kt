...
object RecommendationDisplayReranker {
     ...
     *
     * KMK_CLAUDE_TRACKER_SAFE_LOOKUP_2026-08-09: this is a **tri-state**, not a set, because a bare
    ...
    fun rerank(
        ...
        // KMK_CLAUDE_TRACKER_SAFE_LOOKUP_2026-08-09: tracker state could not be determined for this
