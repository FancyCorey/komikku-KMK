 ...
 * preference marks, and source status.
 *
        ...
        Scaffold(
            ...
            Column(modifier = Modifier.fillMaxSize().padding(top = contentPadding.calculateTopPadding())) {
                ...
                LazyColumn(
                    ...
                    // KMK: user-facing clear action for the
                    ...
                    item(key = "source_header") {
                        // KMK: single pure call replaces the
 ...
 * fullscreen dialogs are built. The compact dialog was too small and did not represent the real For
 * You layout closely enough. The close action is top-left (`AppBar`'s standard
