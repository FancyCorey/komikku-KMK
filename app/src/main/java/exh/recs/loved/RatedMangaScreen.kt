...
internal fun RatedMangaCollectionContent(
    ...
    // KMK: the export input is snapshotted at the
    ...
    // screen leaves composition (navigating away), matching the behavior contract's clear-on-navigation policy.
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Scaffold(
            ...
            bottomBar = {
                if (successState != null && successState.selectionMode) {
                    RatedSelectionBottomBar(
                        ...
                        // More menu too (documented behavior), not only the per-item overflow menu. Only
            ...
            // KMK <--
            // KMK v0.8.7: Undo for reversible bulk actions (documented behavior), reusing this repo's
                            ...
                            Box {
                                MangaItem(
                                    ...
                                    onLongClick = {
                                        ...
                                        // opens recommendations directly.
        ...
        Row(
            ...
            Box {
                ...
                DropdownMenu(expanded = showMoreMenu, onDismissRequest = { showMoreMenu = false }) {
                    // KMK v0.8.7: documented behavior "Select All In Group" under More.
