...
Public documentation includes only reviewed screenshots and purpose-written XML references. Raw device dumps, full logs, databases, preferences, account data, and local paths are not included.
